...
* air accel
* wall jump power
* player took dmg variable (If frozen at `Took No DMG`, end screen will award u 5k Points for taking no dmg.)
...
* Railgun Charge
* Rocket Freeze Time Charge

### Other
There are few debug addresses, that if advanced enough, u can use yourself for playing around.
If the game crashes while doing so however, it's not on me :P
